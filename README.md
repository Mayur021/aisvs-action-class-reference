...
- **`gate/worst_case_chain.py`** — reference implementation of the C9.2.7 worst-case chain rule. Given a sequence of actions, returns the worst-case action class for the entire chain.
...
|---|---|---|
| `read_only` | The action only reads data. It does not change the world. | `read_calendar`, `query_logs`, `fetch_document` |
